...
import com.example.sonic.fspotter.adapters.AdapterDrawerDetail;
...
/**
 * Created by sonic on 26.06.15.
 */
public class FragmentDrawerDetail extends Fragment {
    ...
    */
    ...
    private AdapterDrawerDetail mAdapter;
    ...
    public List<Information> getData() {
        ...
        int[] icons = {R.drawable.marker, R.drawable.list, R.drawable.diaphragm, R.drawable.settings};
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new AdapterDrawerDetail(getActivity(), getData());
