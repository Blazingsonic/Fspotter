...
public class FragmentUpcoming extends Fragment implements SortListener, UpcomingMoviesLoadedListener {
    ...
    private ArrayList<Location> mListMovies = new ArrayList<>();
    ...
    public void onSortByName() {
        mSorter.sortLocationsByName(mListMovies);
        mAdapter.notifyDataSetChanged();
    }

    @Override
    public void onSortByDate() {
        mSorter.sortLocationsByDate(mListMovies);
        mAdapter.notifyDataSetChanged();
    }

    @Override
    public void onSortByRating() {
        mSorter.sortLocationsByRating(mListMovies);
        mAdapter.notifyDataSetChanged();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            mListMovies = MyApplication.getWritableDatabase().readLocations(DBLocations.UPCOMING);
        ...
        mAdapter.setLocations(mListMovies);
        return layout;
    }
    ...
    public void onUpcomingMoviesLoaded(ArrayList<Location> listMovies) {
        mAdapter.setLocations(listMovies);
    }
}
